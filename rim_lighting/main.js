...
window.onload = function init()
{
    ...
    gl.uniform1f( gl.getUniformLocation(program, "shininess"), materialShininess);
		...
		gl.uniform1f( gl.getUniformLocation(program, "scale"), size);
    ...
    document.getElementById( "dButton" ).onclick = function() {depthTest=!depthTest;};
		document.getElementById( "aButton" ).onclick = function() {alphaTest=!alphaTest};
		
		document.getElementById( "bias" ).oninput = function() {bias = this.value/100};
		document.getElementById( "power" ).oninput = function() {power = this.value/100};
		document.getElementById( "scale" ).oninput = function() {size = this.value/100};
...
function render() {
	...
	if (alphaTest) gl.enable(gl.BLEND); else gl.disable(gl.BLEND);
